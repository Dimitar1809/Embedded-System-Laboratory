...
XXDouble pan_xx_start_time = 0.0;
XXDouble pan_xx_finish_time = 20.0;
XXDouble pan_xx_step_size = 0.01;
XXDouble pan_xx_time = 0.0;
XXInteger pan_xx_steps = 0;
XXBoolean pan_xx_initialize = XXTRUE;
XXBoolean pan_xx_major = XXTRUE;
XXBoolean pan_xx_stop_simulation = XXFALSE;

/* the variable arrays */
XXDouble pan_xx_P[pan_xx_parameters_size];		/* parameters */
XXDouble pan_xx_I[pan_xx_initialvalues_size];		/* initial values */
XXDouble pan_xx_V[pan_xx_variables_size];		/* variables */
XXDouble pan_xx_s[pan_xx_states_size];		/* states */
XXDouble pan_xx_R[pan_xx_states_size];		/* rates (or new states) */
...
void pan_XXModelInitialize_variables(void)
{
	...
	memset(pan_xx_V, 0, pan_xx_variables_size * sizeof(XXDouble));
}
